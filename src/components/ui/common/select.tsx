...
const styles = {
	...
	item: cn(
		"rounded-xl gap-2 py-2 pr-8 pl-5 text-base border border-transparent cursor-pointer hover:border-custom-gray/20 hover:bg-custom-gray/10 [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50  duration-100",
		"[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			data-size={size}
			className={cn(styles.trigger(size), className)}
			{...props}
		>
			{children}
	...
	return (
		<SelectPrimitive.Portal>
			<SelectPrimitive.Content
				...
				className={cn(styles.content(position), className)}
				position={position}
				{...props}
			>
